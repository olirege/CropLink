                ...
                <span class="divide-y">
                    <div class="py-4">
                        ...
                        <div class="flex flex-row gap-2 items-center">
                            <input type="number" class="text-xs border rounded-md p-2 w-1/2" v-model="filtersBuffer.tons.min" />
                            <p>-</p>
                            <input type="number" class="text-xs border rounded-md p-2 w-1/2" v-model="filtersBuffer.tons.max"/>
                        </div>
                    </div>
                    <div class="py-4">
                        <p class="text-sm mb-2">Price Per Ton</p>
                        <div class="flex flex-row gap-2 items-center">
                            <input type="number" class="text-xs border rounded-md p-2 w-1/2" v-model="filtersBuffer.pricePerTon.min" />
                        <p>-</p>
                            <input type="number" class="text-xs border rounded-md p-2 w-1/2" v-model="filtersBuffer.pricePerTon.max"/>
                        </div>
                    </div>
                    <span class="py-4">
                        <div class="flex flex-row gap-2 items-center">
