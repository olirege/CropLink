                        ...
                        <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                            ...
                            <DialogDescription class="mt-2 mb-4">
                                <p class="text-sm text-gray-500">
                                    Add an Ad to your profile
                                </p>
                            </DialogDescription>
                            <SellerAddAdForm @close="setIsOpen(false)" v-if="profile?.accountType === ACCOUNT_TYPES.SELLER"/>
                            <BuyerAddAdForm @close="setIsOpen(false)" v-if="profile?.accountType === ACCOUNT_TYPES.BUYER"/>
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import SellerAddAdForm from '@/components/forms/SellerAddAdForm.vue';
import BuyerAddAdForm from '@/components/forms/BuyerAddAdForm.vue';
