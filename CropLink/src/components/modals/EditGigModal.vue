                ...
                <div class="flex min-h-full items-center justify-center p-4 text-center">
                    ...
                    >
                        <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                            ...
                            <GigPostEditForm @close="setIsOpen(false)" :gig="(modals['context'] as Gig)"/>
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import GigPostEditForm from '@/components/forms/GigPostEditForm.vue';
